export const playgroundFixtures: Readonly<Record<string, Readonly<Record<string, unknown>>>> = {
  ...
  'people-directory': {
    people: [
      { id: 'ada', name: 'Ada Mensah', secondary: 'ada@example.org', status: 'active', role: 'Lead' },
      { id: 'jonah', name: 'Jonah Bell', secondary: 'jonah@example.org', status: 'invited', role: 'Mentor' },
    ],
  ...
  'person-row': {
    person: { id: 'ada', name: 'Ada Mensah', secondary: 'ada@example.org', status: 'active', role: 'Lead' },
  },
  'person-summary': {
    view: {
      person: { id: 'ada', name: 'Ada Mensah', secondary: 'Programme lead', status: 'Active' },
  ...
  'phase-lane': {
    ...
    projects: [{ id: 'project-1', title: 'Neighbourhood programme', phaseId: 'develop', summary: 'Active work', progress: 64 }],
  },
  'pip-strip': {
    items: [
  ...
  quiz: {
    view: {
      ...
      questions: [{ id: 'q1', prompt: 'Which option is correct?', type: 'single', options: [{ id: 'a', label: 'Option A' }, { id: 'b', label: 'Option B' }], required: true }],
      answers: {},
      activeIndex: 0,
      submitting: false,
    },
  ...
  'quiz-question': {
    question: { id: 'q1', prompt: 'Which option is correct?', type: 'single', options: [{ id: 'a', label: 'Option A' }, { id: 'b', label: 'Option B' }], required: true },
  },
  radio: { value: 'option-a', name: 'example-radio' },
  'stat-card': { label: 'Active programmes', value: 24, delta: { value: 12, label: 'since last month', direction: 'up' } },
