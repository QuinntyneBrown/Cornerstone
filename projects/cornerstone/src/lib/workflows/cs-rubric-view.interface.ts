...
import { CsRubricCriterion } from './cs-rubric-criterion.interface';

export interface CsRubricView extends CsViewModel {
  readonly criteria: readonly CsRubricCriterion[];
