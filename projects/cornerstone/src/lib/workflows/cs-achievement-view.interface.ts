...
import { CsAchievementProgress } from './cs-achievement-progress.interface';

export interface CsAchievementView extends CsViewModel {
  readonly title: string;
  readonly description?: string;
  readonly earned: boolean;
  readonly progress?: CsAchievementProgress;
}
